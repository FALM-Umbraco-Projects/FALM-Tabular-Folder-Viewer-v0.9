...
using umbraco.presentation.controls;
    ...
    public class FALMTabularFolderBrowserDataEditor : UpdatePanel, IDataEditor
	{
        ...
        protected Panel FilterPanel()
        {
            ...
            foreach (string fieldDesc in searchFields)
            {
                ...
                {
                    case "Date":
                        datePicker dtpckDateFieldFrom = new datePicker();
                        dtpckDateFieldFrom.ID = "dtpck" + strAlias + "From";
                        dtpckDateFieldFrom.EmptyDateAsDefault = true;

                        datePicker dtpckDateFieldTo = new datePicker();
                        dtpckDateFieldTo.ID = "dtpck" + strAlias + "To";
                        dtpckDateFieldTo.EmptyDateAsDefault = true;
		...
		protected string SQLCommandFiltered()
		{
            ...
            TextBox txtBox;
            datePicker dtpckDateFieldFrom;
            datePicker dtpckDateFieldTo;
            bool validFrom;
            bool validTo;
            ...
            foreach (string fieldDesc in searchFields)
            {
                ...
                {
                    case "Date":
                        dtpckDateFieldFrom = (datePicker)pnlFilterProperties.FindControl("dtpck" + strAlias + "From");
                        dtpckDateFieldTo = (datePicker)pnlFilterProperties.FindControl("dtpck" + strAlias + "To");
